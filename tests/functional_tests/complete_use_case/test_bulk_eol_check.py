...
class TestBulkEolCheckTool(DestructiveProductDbFunctionalTest):
    ...
    def test_with_valid_queries(self):
        ...
        self.browser.get(self.server_url + "/productdb/lifecycle/bulkcheck/")
...
MOH
        ...
        expected_product_summary_row = "WS-C2960-24LC-S Catalyst 2960 24 10/100 (8 PoE) + 2 T/SFP LAN Lite Image " \
                                       "4 EoS/EoL"
        expected_not_found_query = "MOH 2 Not found"
        ...
        dt_buttons = self.browser.find_element_by_xpath('//div[@id="product_summary_table-buttons-div"]/'
