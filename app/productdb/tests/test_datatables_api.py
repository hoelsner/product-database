...
class DatatablesApiEndpointTest(TestCase):
    ...
    def test_get_data_from_datatables_lifecycle_endpoint(self):
        url = reverse('productdb:datatables_lifecycle_endpoint', kwargs={'vendor_id': 1})
    ...
    # just smoke tests to verify the basic operation of the datatables server side processing
    def test_get_data_from_datatables_list_products_endpoint(self):
        url = reverse('productdb:datatables_list_products_endpoint', kwargs={'product_list_id': 1})
